...
![alt text](docs/images/image-001.png)
...
> **macOS**: iTerm2 with _Left Option Key = Esc+_ is required for Tmux Option-key pane navigation.
...
| `Prefix` + `H/J/K/L` | Resize pane (step 5) |
